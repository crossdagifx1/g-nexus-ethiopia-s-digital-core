...
export const TeamSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative py-16 md:py-24 lg:py-32 px-4 md:px-6 overflow-hidden">
      ...
      <div className="team-orb-1 absolute top-20 left-20 w-64 h-64 bg-gold/5 rounded-full blur-3xl will-change-transform" />
      <div className="team-orb-2 absolute bottom-20 right-20 w-96 h-96 bg-cyan/5 rounded-full blur-3xl will-change-transform" />
