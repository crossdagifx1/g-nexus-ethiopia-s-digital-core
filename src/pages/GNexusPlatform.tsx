          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <AnimatedSection key={feature.title} delay={index * 100} animation="fadeUp">
                <div className="group p-6 rounded-2xl bg-muted/30 border border-border/50 hover:border-gold/50 transition-all duration-300 h-full">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {plans.map((plan, index) => (
              <AnimatedSection key={plan.name} delay={index * 100} animation="scaleUp">
                <div className={`relative p-8 rounded-3xl h-full flex flex-col ${plan.popular ? 'bg-gradient-to-br from-gold/20 via-background to-cyan/10 border-2 border-gold/50' : 'bg-muted/30 border border-border/50'}`}>
                  {plan.popular && (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <AnimatedSection key={testimonial.author} delay={index * 100} animation="fadeUp">
                <div className="p-6 rounded-2xl bg-muted/30 border border-border/50 h-full flex flex-col">
