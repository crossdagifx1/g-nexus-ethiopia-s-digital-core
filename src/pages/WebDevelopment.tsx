          ...
          <div className="flex flex-wrap justify-center gap-6">
            {technologies.map((tech, index) => (
              <AnimatedSection key={tech.name} delay={index * 50} animation="scaleUp">
                <div className="flex items-center gap-2 px-6 py-3 rounded-full bg-muted/30 border border-border/50 hover:border-gold/50 hover:bg-gold/5 transition-all duration-300 group">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <AnimatedSection key={service.title} delay={index * 100} animation="fadeUp">
                <div className="group relative p-8 rounded-3xl bg-gradient-to-br from-muted/50 to-muted/20 border border-border/50 hover:border-gold/50 transition-all duration-500 h-full">
                  {/* Glow effect */}
        ...
        <AnimatedSection>
          <div className="max-w-4xl mx-auto text-center">
            <div className="relative p-12 rounded-3xl bg-gradient-to-br from-gold/10 via-background to-cyan/10 border border-gold/30 overflow-hidden">
              ...
              <div className="relative z-10">
                <Code className="w-12 h-12 text-gold mx-auto mb-6" />
